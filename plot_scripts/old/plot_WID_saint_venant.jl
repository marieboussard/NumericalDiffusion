...
@time sol = iterate_WID(xmin, xmax, Nx, equation, scheme; nb_it=1, boxBounds=boxBounds, sourceBounds=sourceBounds)
...
# method = scheme
solEnt = optimize_for_entropy(u, domain, equation, scheme)#scheme=LBFGS(); autodiff=:forward
