...
# schemeEulerMuscl = FVScheme(Euler(), MUSCL(CFL_factor, Rusanov(CFL_factor), Superbee()))
schemeRK2Muscl = FVScheme(RK2(), MUSCL(CFL_factor, Rusanov(CFL_factor), Superbee()))
...
plot(pltA..., layout=(1, 2), size=(1100, 600))